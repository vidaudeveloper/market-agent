...
6. 先写「给老板看的话」+「客户关切」，再写 ❗【核心结论】3–6 条（见 DELIVERY-STANDARD 2.0 / 排版规范）
...
复制 `templates/tts-growth-plan.template.md` 开头块：**给老板看的话** → **客户关切** → **❗【核心结论】**。**禁止**单行超长加粗；**第一屏禁止表格**。

| 步骤 | 做法 |
|------|------|
| 0 | 5–8 行纯文字（SCQA：现状→矛盾→要决定什么→主张） |
| 0b | 客户关切三行：决策焦点 / 本次要决定 / 请记住 |
| 1 | 标题下 `>` 阅读指引（共几条） |
| 2 | 每条用 `### 结论 N｜短标题` |
...
- 正文数字、百分比**不加粗**；KPI 放表格（且在「给老板看的话」之后）
