...
2. `skills/tts-pricing-logic/SKILL.md`（**报价必用**）
...
5. 按「强制章节」填满；竞品每家「启示」≥3 条
6. **报价章**：按 tts-pricing-logic GMV→视频量→四岗位→月费/季度费
7. 插入 ≥2 处 <!-- chart -->；附出海匠截图证据
8. feishu-export --charts
```
